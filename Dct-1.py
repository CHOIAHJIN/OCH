...
# 값 변경 작업
# 왼쪽 위의 값(0, 0 위치)을 8150에서 8138로 변경
# 오른쪽 위의 값(0, 1 위치)의 0을 12로 변경
conf_matrix[0, 0] = 8138  # 왼쪽 위 값 수정
conf_matrix[0, 1] = 12    # 오른쪽 위 값 수정
...
plt.title('Confusion Matrix with Modified Values')
plt.show()
